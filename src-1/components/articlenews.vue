<template>
    <body>
        <section class="navigation-site center">
            <span class="navigation-site_text-logo"><img class="navigation-site_logo"
                    src="../assets/Imgarticle&news/img/Logo.jpg" alt="">Interno</span>
    ...
    <footer class="footer_content center">
        <div class="footer_logo">
            <span class="footer_text-logo"><img class="footer-site_logo" src="../assets/Imgarticle&news/img/Logo1.svg"
                    alt="">Interno</span>
            <p class="footer_logo_slogan">It is a long established fact that a reader will be distracted lookings.
            </p>
            ...
            <svg class="logo_in" width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
